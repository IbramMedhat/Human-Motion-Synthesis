...
tf.compat.v1.flags.DEFINE_integer("batch_size", 64, "Batch size to use during training")
tf.compat.v1.flags.DEFINE_integer("epochs", 200, "How many epochs we should train for")
...
# Directories
tf.compat.v1.flags.DEFINE_string("cameras_path","data\h36m\metadata.xml", "File with h36m metadata, including cameras")
tf.compat.v1.flags.DEFINE_string("data_dir",   "data\\h36m\\", "Data directory")
tf.compat.v1.flags.DEFINE_string("train_dir", "experiments", "Training directory.")
...
# To avoid race conditions: https:\\github.com\tensorflow\tensorflow\issues\7448
